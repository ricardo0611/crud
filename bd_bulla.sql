...
-- Exportação de dados foi desmarcado.
-- Copiando estrutura para tabela mysql.ndb_binlog_index
...
CREATE TABLE `host_summary` (
	...
	`statement_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`statement_avg_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`table_scans` DECIMAL(65,0) NULL,
	`file_ios` DECIMAL(64,0) NULL,
	`file_io_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_users` BIGINT(21) NOT NULL,
	`current_memory` TEXT NULL COLLATE 'utf8_general_ci',
	`total_memory_allocated` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io` (
	...
	`io_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io_type` (
	...
	`total_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`max_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_stages` (
	...
	`total` BIGINT(20) UNSIGNED NOT NULL,
	`total_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`avg_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_statement_latency` (
	...
	`total_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`max_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`lock_latency` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `innodb_buffer_stats_by_schema` (
	...
	`allocated` TEXT NULL COLLATE 'utf8_general_ci',
	`data` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `io_by_thread_by_latency` (
	...
	`total` DECIMAL(42,0) NULL,
	`total_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`min_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`avg_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`max_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`thread_id` BIGINT(20) UNSIGNED NOT NULL,
...
CREATE TABLE `io_global_by_file_by_bytes` (
	...
	`count_read` BIGINT(20) UNSIGNED NOT NULL,
	`total_read` TEXT NULL COLLATE 'utf8_general_ci',
	`avg_read` TEXT NULL COLLATE 'utf8_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`total_written` TEXT NULL COLLATE 'utf8_general_ci',
	`avg_write` TEXT NULL COLLATE 'utf8_general_ci',
	`total` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `io_global_by_file_by_latency` (
	...
	`total_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`count_read` BIGINT(20) UNSIGNED NOT NULL,
	`read_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`write_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`count_misc` BIGINT(20) UNSIGNED NOT NULL,
	`misc_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `io_global_by_wait_by_bytes` (
	...
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`total_written` TEXT NULL COLLATE 'utf8_general_ci',
	`avg_written` TEXT NULL COLLATE 'utf8_general_ci',
	`total_requested` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `latest_file_io` (
	...
	`file` VARCHAR(512) NULL COLLATE 'utf8_general_ci',
	`latency` TEXT NULL COLLATE 'utf8_general_ci',
	`operation` VARCHAR(32) NOT NULL COLLATE 'utf8_general_ci',
	`requested` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_by_host_by_current_bytes` (
	...
	`current_allocated` TEXT NULL COLLATE 'utf8_general_ci',
	`current_avg_alloc` TEXT NULL COLLATE 'utf8_general_ci',
	`current_max_alloc` TEXT NULL COLLATE 'utf8_general_ci',
	`total_allocated` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_global_by_current_bytes` (
	...
	`current_alloc` TEXT NULL COLLATE 'utf8_general_ci',
	`current_avg_alloc` TEXT NULL COLLATE 'utf8_general_ci',
	`high_count` BIGINT(20) NOT NULL,
	`high_alloc` TEXT NULL COLLATE 'utf8_general_ci',
	`high_avg_alloc` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `metrics` (
	...
	`Variable_value` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `processlist` (
	...
	`last_statement_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`current_memory` TEXT NULL COLLATE 'utf8_general_ci',
	`last_wait` VARCHAR(128) NULL COLLATE 'utf8_general_ci',
	`last_wait_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`source` VARCHAR(64) NULL COLLATE 'utf8_general_ci',
	`trx_latency` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `schema_index_statistics` (
	...
	`select_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`rows_inserted` BIGINT(20) UNSIGNED NOT NULL,
	`insert_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`rows_updated` BIGINT(20) UNSIGNED NOT NULL,
	`update_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`rows_deleted` BIGINT(20) UNSIGNED NOT NULL,
	`delete_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_redundant_indexes` (
	...
	`redundant_index_columns` TEXT NULL COLLATE 'utf8_general_ci',
	`redundant_index_non_unique` BIGINT(1) NULL,
	`dominant_index_name` VARCHAR(64) NOT NULL COLLATE 'utf8_general_ci',
	`dominant_index_columns` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `schema_table_lock_waits` (
	...
	`waiting_account` TEXT NULL COLLATE 'utf8_general_ci',
	...
	`blocking_account` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `schema_table_statistics` (
	...
	`fetch_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`rows_inserted` BIGINT(20) UNSIGNED NOT NULL,
	`insert_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`rows_updated` BIGINT(20) UNSIGNED NOT NULL,
	`update_latency` TEXT NULL COLLATE 'utf8_general_ci',
	...
	`io_read` TEXT NULL COLLATE 'utf8_general_ci',
	`io_read_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`io_write_requests` DECIMAL(42,0) NULL,
	`io_write` TEXT NULL COLLATE 'utf8_general_ci',
	`io_write_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` TEXT NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_allocated` TEXT NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_data` TEXT NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_free` TEXT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `x$schema_flattened_keys` (
	...
	`index_columns` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`version` AS select '1.5.1' AS `sys_version`,version() AS `mysql_version`;
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$host_summary_by_statement_latency` AS select if(isnull(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,max(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME`) AS `lock_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT`) AS `rows_sent`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED`) AS `rows_examined`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED`) AS `rows_affected`,(sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED`) + sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`)) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` group by if(isnull(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) order by sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) desc;
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$innodb_buffer_stats_by_schema` AS select if((locate('.',`ibp`.`TABLE_NAME`) = 0),'InnoDB System',replace(substring_index(`ibp`.`TABLE_NAME`,'.',1),'`','')) AS `object_schema`,sum(if((`ibp`.`COMPRESSED_SIZE` = 0),16384,`ibp`.`COMPRESSED_SIZE`)) AS `allocated`,sum(`ibp`.`DATA_SIZE`) AS `data`,count(`ibp`.`PAGE_NUMBER`) AS `pages`,count(if((`ibp`.`IS_HASHED` = 'YES'),1,NULL)) AS `pages_hashed`,count(if((`ibp`.`IS_OLD` = 'YES'),1,NULL)) AS `pages_old`,round(ifnull((sum(`ibp`.`NUMBER_RECORDS`) / nullif(count(distinct `ibp`.`INDEX_NAME`),0)),0),0) AS `rows_cached` from `information_schema`.`innodb_buffer_page` `ibp` where (`ibp`.`TABLE_NAME` is not null) group by `object_schema` order by sum(if((`ibp`.`COMPRESSED_SIZE` = 0),16384,`ibp`.`COMPRESSED_SIZE`)) desc;
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$io_by_thread_by_latency` AS select if(isnull(`performance_schema`.`threads`.`PROCESSLIST_ID`),substring_index(`performance_schema`.`threads`.`NAME`,'/',-(1)),concat(`performance_schema`.`threads`.`PROCESSLIST_USER`,'@',`performance_schema`.`threads`.`PROCESSLIST_HOST`)) AS `user`,sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,min(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MIN_TIMER_WAIT`) AS `min_latency`,avg(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`AVG_TIMER_WAIT`) AS `avg_latency`,max(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID` AS `thread_id`,`performance_schema`.`threads`.`PROCESSLIST_ID` AS `processlist_id` from (`performance_schema`.`events_waits_summary_by_thread_by_event_name` left join `performance_schema`.`threads` on((`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID` = `performance_schema`.`threads`.`THREAD_ID`))) where ((`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`EVENT_NAME` like 'wait/io/file/%') and (`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT` > 0)) group by `performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID`,`performance_schema`.`threads`.`PROCESSLIST_ID`,`user` order by sum(`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT`) desc;
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$memory_by_thread_by_current_bytes` AS select `t`.`THREAD_ID` AS `thread_id`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',`t`.`PROCESSLIST_HOST`),replace(`t`.`NAME`,'thread/','')) AS `user`,sum(`mt`.`CURRENT_COUNT_USED`) AS `current_count_used`,sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_allocated`,ifnull((sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) / nullif(sum(`mt`.`CURRENT_COUNT_USED`),0)),0) AS `current_avg_alloc`,max(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_max_alloc`,sum(`mt`.`SUM_NUMBER_OF_BYTES_ALLOC`) AS `total_allocated` from (`performance_schema`.`memory_summary_by_thread_by_event_name` `mt` join `performance_schema`.`threads` `t` on((`mt`.`THREAD_ID` = `t`.`THREAD_ID`))) group by `t`.`THREAD_ID`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',`t`.`PROCESSLIST_HOST`),replace(`t`.`NAME`,'thread/','')) order by sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) desc;
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_lock_waits` AS select `g`.`OBJECT_SCHEMA` AS `object_schema`,`g`.`OBJECT_NAME` AS `object_name`,`pt`.`THREAD_ID` AS `waiting_thread_id`,`pt`.`PROCESSLIST_ID` AS `waiting_pid`,`sys`.`ps_thread_account`(`p`.`OWNER_THREAD_ID`) AS `waiting_account`,`p`.`LOCK_TYPE` AS `waiting_lock_type`,`p`.`LOCK_DURATION` AS `waiting_lock_duration`,`pt`.`PROCESSLIST_INFO` AS `waiting_query`,`pt`.`PROCESSLIST_TIME` AS `waiting_query_secs`,`ps`.`ROWS_AFFECTED` AS `waiting_query_rows_affected`,`ps`.`ROWS_EXAMINED` AS `waiting_query_rows_examined`,`gt`.`THREAD_ID` AS `blocking_thread_id`,`gt`.`PROCESSLIST_ID` AS `blocking_pid`,`sys`.`ps_thread_account`(`g`.`OWNER_THREAD_ID`) AS `blocking_account`,`g`.`LOCK_TYPE` AS `blocking_lock_type`,`g`.`LOCK_DURATION` AS `blocking_lock_duration`,concat('KILL QUERY ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_query`,concat('KILL ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_connection` from (((((`performance_schema`.`metadata_locks` `g` join `performance_schema`.`metadata_locks` `p` on(((`g`.`OBJECT_TYPE` = `p`.`OBJECT_TYPE`) and (`g`.`OBJECT_SCHEMA` = `p`.`OBJECT_SCHEMA`) and (`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`) and (`g`.`LOCK_STATUS` = 'GRANTED') and (`p`.`LOCK_STATUS` = 'PENDING')))) join `performance_schema`.`threads` `gt` on((`g`.`OWNER_THREAD_ID` = `gt`.`THREAD_ID`))) join `performance_schema`.`threads` `pt` on((`p`.`OWNER_THREAD_ID` = `pt`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `gs` on((`g`.`OWNER_THREAD_ID` = `gs`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `ps` on((`p`.`OWNER_THREAD_ID` = `ps`.`THREAD_ID`))) where (`g`.`OBJECT_TYPE` = 'TABLE');
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_statistics_with_buffer` AS select `pst`.`OBJECT_SCHEMA` AS `table_schema`,`pst`.`OBJECT_NAME` AS `table_name`,`pst`.`COUNT_FETCH` AS `rows_fetched`,`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,`pst`.`COUNT_INSERT` AS `rows_inserted`,`pst`.`SUM_TIMER_INSERT` AS `insert_latency`,`pst`.`COUNT_UPDATE` AS `rows_updated`,`pst`.`SUM_TIMER_UPDATE` AS `update_latency`,`pst`.`COUNT_DELETE` AS `rows_deleted`,`pst`.`SUM_TIMER_DELETE` AS `delete_latency`,`fsbi`.`count_read` AS `io_read_requests`,`fsbi`.`sum_number_of_bytes_read` AS `io_read`,`fsbi`.`sum_timer_read` AS `io_read_latency`,`fsbi`.`count_write` AS `io_write_requests`,`fsbi`.`sum_number_of_bytes_write` AS `io_write`,`fsbi`.`sum_timer_write` AS `io_write_latency`,`fsbi`.`count_misc` AS `io_misc_requests`,`fsbi`.`sum_timer_misc` AS `io_misc_latency`,`ibp`.`allocated` AS `innodb_buffer_allocated`,`ibp`.`data` AS `innodb_buffer_data`,(`ibp`.`allocated` - `ibp`.`data`) AS `innodb_buffer_free`,`ibp`.`pages` AS `innodb_buffer_pages`,`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,`ibp`.`pages_old` AS `innodb_buffer_pages_old`,`ibp`.`rows_cached` AS `innodb_buffer_rows_cached` from ((`performance_schema`.`table_io_waits_summary_by_table` `pst` left join `sys`.`x$ps_schema_table_statistics_io` `fsbi` on(((`pst`.`OBJECT_SCHEMA` = `fsbi`.`table_schema`) and (`pst`.`OBJECT_NAME` = `fsbi`.`table_name`)))) left join `sys`.`x$innodb_buffer_stats_by_table` `ibp` on(((`pst`.`OBJECT_SCHEMA` = `ibp`.`object_schema`) and (`pst`.`OBJECT_NAME` = `ibp`.`object_name`)))) order by `pst`.`SUM_TIMER_WAIT` desc;
